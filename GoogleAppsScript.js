 ...
 * ========== 사용법 ==========
 * 
 * 1. 신규주문 시트에서 [택배사]와 [운송장번호] 입력
 * 2. 자동으로 [완료] 시트로 이동됨
 * 3. 고객은 두 시트 모두에서 조회 가능
 * 
 * ========== 택배사 입력 예시 ==========
 * CJ대한통운, 롯데택배, 한진택배, 우체국, 로젠택배, 직접전달
 * 
 */
 ...
 * [설정 방법]
 * 1. 이 코드 저장 후
 * 2. 상단 메뉴: 실행 > 함수 실행 > createTrigger 선택
 * 3. 권한 승인
 */
function onEdit(e) {
  ...
  // 신규주문 시트의 O열(15번째, 운송장번호)이 수정된 경우
